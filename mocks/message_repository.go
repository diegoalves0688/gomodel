...
func (_m *MessageRepository) Create(_a0 context.Context, _a1 *domain.Message) error {
...
func (_m *MessageRepository) Find(_a0 context.Context) ([]domain.Message, error) {
	ret := _m.Called(_a0)
...
func (_m *MessageRepository) FindByID(_a0 context.Context, _a1 uuid.UUID) (*domain.Message, error) {
	ret := _m.Called(_a0, _a1)
